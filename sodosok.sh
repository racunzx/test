#!/bin/bash
#shadowsocks-libev obfs install by PL4YB0Y3
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/playboye/test/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/playboye/test/main/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/playboye/test/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/playboye/test/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
