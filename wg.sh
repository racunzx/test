...
echo -e "${Info} Wireguard VPS AutoScript by PL4YB0Y3"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/playboye/test/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/playboye/test/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/playboye/test/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/playboye/test/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
