...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/playboye/test/main/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By BOY3VPN
Documentation=https://boyevpn.xyz
Documentation=https://t.me/boyevpn
