...
echo -e  "$PURPLE  '-------------------------------------------------------'$NC"
echo -e "   $green 1)$NC $yell SSH & OpenVPN Menu       $green  6)$NC $yell XRAY TCP XTLS Menu"
echo -e "   $green 2)$NC $yell Wireguard Menu           $green  7)$NC $yell Trojan GFW Menu"
echo -e "   $green 3)$NC $yell SSR & SS Menu            $green  8)$NC $yell SYSTEM Menu"
echo -e "   $green 4)$NC $yell XRAY VMESS Menu          $green  9)$NC $yell Script Install Log"
echo -e "   $green 5)$NC $yell XRAY VLESS Menu          $green 10)$NC $red REBOOT"
echo -e  "$PURPLE  .-------------------------------------------------------."
